...
public class ArrayTest {
    ...
    public void testPermutation() {
        ...
        System.out.println("next permutation:");
        while (ArrayUtil.nextPermutation(ps, Comparator.comparingInt(Point::getX), ArrayUtil::println)) System.out.println("next permutation:");
    }

    @Test
    public void testCombination() {
        Integer[] a = {1, 2, 3, 4};
        ArrayUtil.combination(a, null);
